var cellSize = 168, boardSize = 3, totalTurns = boardSize * boardSize;  // cellSize and style settings involving it (width, height) are experimental.
...
function StartGame() {
    ...
    setTimeout(clear, 500); // ...to clear it for a new game
    function clear() {
